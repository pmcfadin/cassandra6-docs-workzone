...
and doesn't fully overlap with the xref:operators::operate/onboarding-to-accord.adoc[user guide]. You should start with the
xref:operators::operate/onboarding-to-accord.adoc[user guide] to get any context that may be missing here.
