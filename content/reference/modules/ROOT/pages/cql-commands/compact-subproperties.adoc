...
See xref:operators::operate/compaction/index.adoc[Compaction Strategies] for more details.
====
...
See xref:operators::operate/compaction/stcs.adoc[SizeTieredCompactionStrategy (STCS)].
...
[NOTE]
==== 
The `cold_reads_to_omit` property for xref:operators::operate/compaction/stcs.adoc[SizeTieredCompactionStrategy (STCS)] is no longer supported.
====
...
See xref:operators::operate/compaction/lcs.adoc[LeveledCompactionStrategy (LCS)].
...
See xref:operators::operate/compaction/twcs.adoc[TimeWindowCompactionStrategy (TWCS)].
