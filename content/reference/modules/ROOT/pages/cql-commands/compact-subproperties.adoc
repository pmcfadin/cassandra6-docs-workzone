...
See xref:Cassandra:cassandra:managing/operating/compaction/index.adoc[Compaction Strategies] for more details.
====
...
This reduces compaction wall-clock duration but disables preemptive SSTable opening for parallelized compactions.
+
...
See xref:Cassandra:cassandra:managing/operating/compaction/stcs.adoc[SizeTieredCompactionStrategy (STCS)].
...
[NOTE]
==== 
The `cold_reads_to_omit` property for xref:Cassandra:cassandra:managing/operating/compaction/stcs.adoc[SizeTieredCompactionStrategy (STCS)] is no longer supported.
====
...
See xref:Cassandra:cassandra:managing/operating/compaction/lcs.adoc[LeveledCompactionStrategy (LCS)].
...
For related information, see xref:developers::indexing/sai/configuring.adoc#saiConfigure__saiCompactionStrategies[Compaction strategies].
====
...
See xref:Cassandra:cassandra:managing/operating/compaction/twcs.adoc[TimeWindowCompactionStrategy (TWCS)].
