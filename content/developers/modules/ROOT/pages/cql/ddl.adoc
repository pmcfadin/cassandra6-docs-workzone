...
* Triggers
* Materialized views
* Custom indexes; if the source table has custom indexes and `WITH INDEXES` is specified, a client warning is emitted for each custom index that could not be copied
