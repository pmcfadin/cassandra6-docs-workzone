...
| `compression` |_map_ |_see below_ | xref:operators::operate/compression/index.adoc#cql-compression-options[Compression options]
...
* `'SizeTieredCompactionStrategy'`, xref:operators::operate/compaction/stcs.adoc#stcs[STCS] (Default)
* `'LeveledCompactionStrategy'`, xref:operators::operate/compaction/lcs.adoc#lcs[LCS]
* `'TimeWindowCompactionStrategy'`, xref:operators::operate/compaction/twcs.adoc#twcs[TWCS]

If a custom strategies is required, specify the full class name as a xref:cql/definitions.adoc#constants[string constant].

All default strategies support a number of xref:operators::operate/compaction-overview.adoc#compaction-options[common options], as well as options specific to the strategy chosen. See the section corresponding to your strategy for details: xref:operators::operate/compaction/stcs.adoc#stcs_options[STCS], xref:operators::operate/compaction/lcs.adoc#lcs_options[LCS], xref:operators::operate/compaction/twcs.adoc#twcs_options[TWCS].
