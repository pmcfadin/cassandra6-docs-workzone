...
list of those keywords can be found in xref:Cassandra:cassandra:developing/cql/appendices.adoc#appendix-A[Appendix A].
...
[source, bnf]
----
include::Cassandra:cassandra:example$BNF/identifier.bnf[]
----
...
[source, bnf]
----
include::Cassandra:cassandra:example$BNF/constant.bnf[]
----
...
[source, bnf]
----
include::Cassandra:cassandra:example$BNF/cql_statement.bnf[]
----
