...
[source,bnf]
----
include::Cassandra:cassandra:example$BNF/term.bnf[]
----

A term is thus one of:

* A xref:cql/definitions.adoc#constants[constant]
...
* An xref:Cassandra:cassandra:developing/cql/operators.adoc#arithmetic_operators[arithmetic operation] between terms
* A type hint
...
xref:reference::configuration/cassandra_yaml_file.adoc#_prepared_statements_cache_size[`prepared_statements_cache_size`].
...
[source,bnf]
include::Cassandra:cassandra:example$BNF/create_table_like.bnf[]

_Sample:_

[source,sql]
----
include::Cassandra:cassandra:example$CQL/create_table_like.cql[]
----
...
[source,bnf]
include::Cassandra:cassandra:example$BNF/create_index_statement.bnf[]

_Sample:_

[source,sql]
include::Cassandra:cassandra:example$CQL/create_index.cql[]
...
[source,bnf]
include::Cassandra:cassandra:example$BNF/drop_index_statement.bnf[]
...
[source,bnf]
include::Cassandra:cassandra:example$BNF/create_mv_statement.bnf[]

_Sample:_

[source,sql]
include::Cassandra:cassandra:example$CQL/create_mv_statement.cql[]
...
[source,bnf]
include::Cassandra:cassandra:example$BNF/drop_mv_statement.bnf[]
...
[source,bnf]
include::Cassandra:cassandra:example$BNF/create_type.bnf[]
...
[source,bnf]
include::Cassandra:cassandra:example$BNF/create_trigger_statement.bnf[]

_Sample:_

[source,sql]
include::Cassandra:cassandra:example$CQL/create_trigger.cql[]
...
[source,bnf]
include::Cassandra:cassandra:example$BNF/drop_trigger_statement.bnf[]

_Sample:_

[source,sql]
include::Cassandra:cassandra:example$CQL/drop_trigger.cql[]
...
[source,bnf]
----
include::Cassandra:cassandra:example$BNF/create_function_statement.bnf[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/create_function.cql[]
----
...
[source,bnf]
include::Cassandra:cassandra:example$BNF/drop_function_statement.bnf[]

_Sample:_

[source,sql]
include::Cassandra:cassandra:example$CQL/drop_function.cql[]
...
[source,bnf]
include::Cassandra:cassandra:example$BNF/create_aggregate_statement.bnf[]
...
[source,bnf]
include::Cassandra:cassandra:example$BNF/drop_aggregate_statement.bnf[]

_Sample:_

[source,sql]
include::Cassandra:cassandra:example$CQL/drop_aggregate.cql[]
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/vector.cql[]
----
...
[source,sql]
include::Cassandra:cassandra:example$CQL/timeuuid_now.cql[]
...
[source,sql]
include::Cassandra:cassandra:example$CQL/timeuuid_min_max.cql[]
...
[source,sql]
include::Cassandra:cassandra:example$CQL/count.cql[]

It also can be used to count the non null value of a given column.
Example:

[source,sql]
include::Cassandra:cassandra:example$CQL/count_nonnull.cql[]
...
[source,sql]
include::Cassandra:cassandra:example$CQL/min_max.cql[]
...
[source,sql]
include::Cassandra:cassandra:example$CQL/sum.cql[]
...
[source,sql]
include::Cassandra:cassandra:example$CQL/avg.cql[]
