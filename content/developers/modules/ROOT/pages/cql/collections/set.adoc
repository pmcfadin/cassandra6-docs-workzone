...
* xref:Cassandra:cassandra:developing/cql/keyspace-check.adoc[Keyspace] must exist
...
[source,results]
----
include::Cassandra:cassandra:example$RESULTS/sai/select_all_from_cyclist_career_teams.result[]
----
--
====
