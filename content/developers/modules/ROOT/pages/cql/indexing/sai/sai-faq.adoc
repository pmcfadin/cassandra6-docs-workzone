...
See xref:home:cassandra:getting-started/sai-quickstart.adoc[SAI quickstart].
...
Refer to xref:cql/indexing/sai/operations/configuring.adoc[Configure SAI indexes].
...
Start in xref:home:cassandra:getting-started/sai-quickstart.adoc[SAI quickstart].
...
See xref:reference::cql-commands/create-custom-index.adoc[CREATE CUSTOM INDEX] and examples in the xref:home:cassandra:getting-started/sai-quickstart.adoc[SAI quickstart] topic.
====
