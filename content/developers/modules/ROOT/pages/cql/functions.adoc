...
* xref:cql/functions.adoc#scalar-native-functions[scalar functions] that take a number of values and produce an output
...
[source, bnf]
----
include::Cassandra:cassandra:example$BNF/function.bnf[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/create_table_simple.cql[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/current_date.cql[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/to_date.cql[]
----
...
For every xref:cql/types.adoc#native-types[type] supported by CQL, the function `type_as_blob` takes an argument of type `type` and returns it as a `blob`.
...
| `octet_length` | All xref:cql/types.adoc#native-types[types] | Returns the length of the data in bytes.

| `length` | `text` | Returns the string's length - the count of UTF-16 code units.
|===

The `octet_length` function is defined for every xref:cql/types.adoc#native-types[type]
...
number of UTF-16 code units. Equivalent to Java's
...
include::Cassandra:cassandra:partial$masking_functions.adoc[]
...
include::Cassandra:cassandra:partial$vector-search/vector_functions.adoc[]
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/function_overload.cql[]
----
...
Tuple types and user-defined types use the Apache Cassandra Java Driver conversion functions.
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/function_dollarsign.cql[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/function_udfcontext.cql[]
----
...
[source,java]
----
include::Cassandra:cassandra:example$JAVA/udfcontext.java[]
----
...
[source,java]
----
include::Cassandra:cassandra:example$JAVA/udf_imports.java[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/sum_with_cast.cql[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/avg_with_cast.cql[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/uda.cql[]
----
