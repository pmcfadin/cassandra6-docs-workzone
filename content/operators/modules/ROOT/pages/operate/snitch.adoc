...
[NOTE]
====
The `SnitchAdapter` bridge class is the compatibility layer that keeps
legacy `endpoint_snitch` settings working while Cassandra 6 routes new
deployments through the split topology settings.
====
