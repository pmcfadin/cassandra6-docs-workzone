...
- *Large SSTables*: When using xref:home:cassandra:managing/operating/compaction/stcs.adoc[SizeTieredCompactionStrategy] or any
...
- *Partitions overlapping many SSTables*: If partitions overlap between many SSTables, the amount of SSTables included
  ...
  session and must all be anticompacted. xref:home:cassandra:managing/operating/compaction/lcs.adoc[LeveledCompactionStrategy] is less
