...
xref:operate/compaction-overview.adoc#types-of-compaction[anticompaction work].
...
xref:reference::nodetool/nodetool.adoc[nodetool command reference] to mark all SSTables as repaired
