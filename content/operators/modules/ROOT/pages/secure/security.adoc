...
// TODO: Restore crypto providers section. The `crypto_provider` configuration is active in Cassandra 6.0.
// `DefaultCryptoProvider` installs Amazon Corretto Crypto Provider with fallback to JRE, configured by default in `cassandra.yaml`.
// This section was present in the 5.0 docs and should be added back as a full subsection.
