...
* xref:reference::configuration/cassandra_yaml_file.adoc[Configuration Reference] -- full `cassandra.yaml` property reference
* xref:developers::cql/ddl.adoc[CQL Data Definition] -- `CREATE KEYSPACE` and `ALTER KEYSPACE` syntax reference
