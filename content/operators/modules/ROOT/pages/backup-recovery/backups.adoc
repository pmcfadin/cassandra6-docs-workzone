...
Ephemeral snapshots are created and managed by Cassandra for internal operations such as
truncate and drop handling. You do not delete them by hand; Cassandra removes them when the
operation completes and the snapshot is no longer needed. Treat them as part of the normal
write path, not as operator-managed backup artifacts.
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/create_ks_backup.cql[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/create_table_backup.cql[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/insert_data_backup.cql[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/select_data_backup.cql[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$RESULTS/select_data_backup.result[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/create_ks2_backup.cql[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/create_table2_backup.cql[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/insert_data2_backup.cql[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$CQL/select_data2_backup.cql[]
----
...
[source,sql]
----
include::Cassandra:cassandra:example$RESULTS/select_data2_backup.result[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/nodetool_snapshot.sh[]
----
...
[source, plaintext]
----
include::Cassandra:cassandra:example$RESULTS/nodetool_snapshot_help.result[]
----
...
[source,yaml]
----
include::Cassandra:cassandra:example$YAML/auto_snapshot.yaml[]
----
...
[source,yaml]
----
include::Cassandra:cassandra:example$YAML/snapshot_before_compaction.yaml[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/find_snapshots.sh[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/snapshot_backup2.sh[]
----
...
[source,none]
----
include::Cassandra:cassandra:example$RESULTS/snapshot_backup2.result[]
----
...
[source, plaintext]
----
include::Cassandra:cassandra:example$RESULTS/snapshot_backup2_find.result[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/snapshot_both_backups.sh[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/snapshot_one_table.sh[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/snapshot_one_table2.sh[]
----
...
[source, plaintext]
----
include::Cassandra:cassandra:example$RESULTS/snapshot_one_table2.result[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/snapshot_mult_tables.sh[]
----
...
[source,plaintext]
----
include::Cassandra:cassandra:example$RESULTS/snapshot_mult_tables.result[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/snapshot_mult_tables_again.sh[]
----
...
[source, plaintext]
----
include::Cassandra:cassandra:example$RESULTS/snapshot_mult_tables_again.result[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/snapshot_mult_ks.sh[]
----

results in
[source, plaintext]
----
include::Cassandra:cassandra:example$RESULTS/snapshot_mult_ks.result[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/nodetool_list_snapshots.sh[]
----
...
[source, plaintext]
----
include::Cassandra:cassandra:example$RESULTS/nodetool_list_snapshots.result[]
----
...
[source, bash]
----
include::Cassandra:cassandra:example$RESULTS/nodetool_list_snapshots_ephemeral.result[]
----

[NOTE]
====
You cannot manually remove ephemeral snapshots.
====
...
[source, cql]
----
include::Cassandra:cassandra:example$RESULTS/cqlsh_list_snapshots.result[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$RESULTS/nodetool_snapshot_take_ttl.result[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$RESULTS/nodetool_snapshot_list_ttl_snapshots.result[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$RESULTS/nodetool_list_snapshot_empty.result[]
----
...
[source, plaintext]
----
include::Cassandra:cassandra:example$RESULTS/snapshot_all.result[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/find_two_snapshots.sh[]
----
...
[source, plaintext]
----
include::Cassandra:cassandra:example$RESULTS/find_two_snapshots.result[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/snapshot_files.sh[]
----
...
[source, plaintext]
----
include::Cassandra:cassandra:example$RESULTS/snapshot_files.result[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/nodetool_clearsnapshot.sh[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/nodetool_clearsnapshot_all.sh[]
----
...
[source,yaml]
----
include::Cassandra:cassandra:example$YAML/incremental_bups.yaml[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/nodetool_flush.sh[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/find_backups.sh[]
----
results in
[source,none]
----
include::Cassandra:cassandra:example$RESULTS/find_backups.result[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/nodetool_flush_table.sh[]
----
...
[source,plaintext]
----
include::Cassandra:cassandra:example$RESULTS/find_backups_table.result[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/check_backups.sh[]
----
...
[source, plaintext]
----
include::Cassandra:cassandra:example$RESULTS/no_bups.result[]
----
...
[source,bash]
----
include::Cassandra:cassandra:example$BASH/flush_and_check.sh[]
----
...
[source, plaintext]
----
include::Cassandra:cassandra:example$RESULTS/flush_and_check.result[]
----
...
[source,none]
----
include::Cassandra:cassandra:example$RESULTS/flush_and_check2.result[]
----

== JMX Access to Snapshot Operations

From Cassandra 6.0
(https://issues.apache.org/jira/browse/CASSANDRA-18111[CASSANDRA-18111]),
all snapshot operations are consolidated under a dedicated
`SnapshotManager` with its own MBean:

----
org.apache.cassandra.service.snapshot:type=SnapshotManager
----

This MBean exposes `takeSnapshot`, `clearSnapshot`, `listSnapshots`,
`getTrueSnapshotSize`, `setSnapshotLinksPerSecond`, `getSnapshotLinksPerSecond`,
and a `restart()` method to force a reload of snapshot metadata from disk.

The equivalent methods on `StorageServiceMBean` (`takeSnapshot`, `clearSnapshot`,
`getSnapshotDetails`, `trueSnapshotsSize`) are deprecated since Cassandra 5.1
but remain functional. Operators using custom JMX tooling for snapshot
automation should migrate to the new MBean path.

NOTE: The nodetool commands `snapshot`, `listsnapshots`, and `clearsnapshot`
are unaffected -- they continue to work as before and internally delegate
to `SnapshotManagerMBean`.

Source: `src/java/org/apache/cassandra/service/snapshot/SnapshotManagerMBean.java`
