...
reading through the xref:Cassandra:cassandra:troubleshooting/use_tools.adoc[Diving Deep, using external tools]
section.
...
There are different xref:operate/compaction-overview.adoc[compaction] strategies available
