...
See xref:observe/virtualtables.adoc#_thread_pools_virtual_table[Thread Pools Virtual Table].
...
See xref:observe/virtualtables.adoc#_clients_virtual_table[Clients Virtual Table].
