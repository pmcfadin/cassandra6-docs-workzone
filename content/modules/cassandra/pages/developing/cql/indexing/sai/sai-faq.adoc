...
See xref:cassandra:developing/cql/indexing/sai/collections.adoc#saiUsingFrozenCollections[Frozen collection indexing] for examples and a full list of supported index targets.
