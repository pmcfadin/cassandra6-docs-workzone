...
xref:cql/indexes.adoc[SAI index] on that column.
...
See the section on xref:cql/json.adoc[JSON support] for more detail.
...
See the section on xref:cql/counter-column.adoc[counters] for details.
